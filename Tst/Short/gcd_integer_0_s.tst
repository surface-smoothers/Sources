...
gcd(0, 3123*123456);
gcdTest(0, 3123*123456, 3123*123456);
gcd(4353*8798, 0);
gcdTest(4353*8798, 0, 0);
...
gcd(23123, f);
gcd(f, 13123);
gcdTest(23123,f,13123);

f=11*47894*19*(-9554*x^4-12895*x^3-10023*x^2-6213*x);

gcd(0, 3123*(123456*a));
gcd(4353*8798, 0);
gcdTest( 4353*8798, 0, 3123*(123456*a) );
...
gcd(23123*(3*a), f);
gcdTest(23123*(3*a), f, 23123*(3*a)*f);
gcd(f, 13123*2);
gcdTest(f, 13123*2, f* 13123*2);
